class Level00 extends BaseLevel {
  ...
  setup() {
    ...
    this.ground.push(new Ground(this.width / 2, this.height - gridSize / 2, width, gridSize, 0, '#629749'));
  ...
  setupHumans() {
    this.humans.push(new Human(this.width / 2 - 75, this.height - gridSize, 100, this.humanHitCallback));
    this.humans.push(new Human(this.width / 2 + 75, this.height - gridSize, 95, this.humanHitCallback));
    this.humans.push(new Human(this.width / 2, this.height - gridSize, 110, this.humanHitCallback));
  }
